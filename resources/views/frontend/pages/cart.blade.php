								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											@endphp
											<td class="image" data-title="No"><img src="{{url('').'/'.$photo[0]}}" alt="{{url('').'/'.$photo[0]}}"></td>
											<td class="product-des" data-title="Description">
												<p class="product-name"><a href="{{route('product-detail',$cart->product['slug'])}}" target="_blank">{{$cart->product['title']}}</a></p>
												<p class="product-des">{!!($cart['summary']) !!}</p>
											</td>
											<td class="price" data-title="Price"><span>{{number_format($cart['price'],2)}}Rs</span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">{{$cart['amount']}}Rs</span></td>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">You Save<span>{{number_format(Session::get('coupon')['value'],2)}}Rs</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">You Pay<span>{{number_format($total_amount,2)}}Rs</span></li>
										@else
											<li class="last" id="order_total_price">You Pay<span>{{number_format($total_amount,2)}}Rs</span></li>
										@endif
									</ul>
